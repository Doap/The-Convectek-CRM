...
class App_Shortcode_ServiceProviders extends App_Shortcode {
	public function __construct () {
		$this->_defaults = array(
			'select' => array(
				'value' => __('Choose a technician:', 'appointments'),
				'help' => __('Text above the select menu. Default: "Select a service"', 'appointments'),
				'example' => __('Choose a technician:', 'appointments'),
			),
			'empty_option' => array(
