<?php
     ...
     *
     */
    function pms_member_add_user_role( $insert_result, $user_id, $subscription_plan_id, $start_date, $expiration_date, $status ) {
    ...
    function pms_member_remove_user_role( $delete_result, $user_id, $subscription_plan_id ) {
        ...
        $subscription_plan_user_role = get_post_meta( $subscription_plan_id, 'pms_subscription_plan_user_role', true );
