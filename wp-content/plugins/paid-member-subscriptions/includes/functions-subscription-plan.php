 ...
 */
    ...
    function pms_output_subscription_plans( $include = array(), $exclude_id_group = array(), $member = false, $default_checked = '' ) {
        ...
        if( $member )
            $output = '<div class="pms-subscription-plans-header"><span class="pms-subscription-plan-name">' . __( 'Subscription' , 'paid-member-subscriptions' ) . '</span><span class="pms-subscription-plan-expiration">' . __( 'Expires', 'paid-member-subscriptions' ) . '</span></div>' . $output;
