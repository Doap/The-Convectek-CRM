...
<form id="pms_edit-profile-form" class="pms-form" method="POST">
    ...
    <ul class="pms-form-fields-wrapper">
        ...
        <li class="pms-field">
            ...
            <input id="pms_user_login" name="user_login" type="text" value="<?php echo $user->user_login; ?>" disabled />
        </li>
        ...
        <li class="pms-field <?php echo ( !empty( $field_errors ) ? 'pms-field-error' : '' ); ?>">
            ...
            <input id="pms_user_email" name="user_email" type="text" value="<?php echo $user->user_email; ?>" />
        ...
        <li class="pms-field <?php echo ( !empty( $field_errors ) ? 'pms-field-error' : '' ); ?>">
            ...
            <input id="pms_first_name" name="first_name" type="text" value="<?php echo $user->first_name; ?>" />
        ...
        <li class="pms-field <?php echo ( !empty( $field_errors ) ? 'pms-field-error' : '' ); ?>">
            ...
            <input id="pms_last_name" name="last_name" type="text" value="<?php echo $user->last_name; ?>" />
