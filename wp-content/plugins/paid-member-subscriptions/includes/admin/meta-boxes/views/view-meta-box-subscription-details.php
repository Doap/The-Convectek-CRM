...
<div class="pms-meta-box-field-wrapper">
    ...
    <textarea id="pms-subscription-plan-description" name="pms_subscription_plan_description" class="widefat" placeholder="<?php echo __( 'Write description', 'paid-member-subscriptions' ); ?>"><?php echo $subscription_plan->description; ?></textarea>
...
<div class="pms-meta-box-field-wrapper">
    ...
    <input type="text" id="pms-subscription-plan-price" name="pms_subscription_plan_price" class="small" value="<?php echo $subscription_plan->price; ?>" /> <?php echo (!empty( $settings['payments']['currency'] )) ? $settings['payments']['currency'] : '' ?>
...
<div class="pms-meta-box-field-wrapper">
    ...
    <select id="pms-subscription-plan-user-role" name="pms_subscription_plan_user_role">
        ...
        <?php foreach( pms_get_user_role_names() as $role_slug => $role_name ): ?>
            <option value="<?php echo $role_slug; ?>" <?php selected( $role_slug, $subscription_plan->user_role, true); ?> ><?php echo $role_name; ?></option>
        <?php endforeach; ?>
