...
Class PMS_Meta_Box_Subscription_Details extends PMS_Meta_Box {
    ...
    public function save_data( $post_id ) {
        ...
        if( isset( $_POST['pms_subscription_plan_description'] ) )
            update_post_meta( $post_id, 'pms_subscription_plan_description', $_POST['pms_subscription_plan_description'] );
        ...
        if( isset( $_POST['pms_subscription_plan_status'] ) ) {
            update_post_meta($post_id, 'pms_subscription_plan_status', $_POST['pms_subscription_plan_status']);

            $status = $_POST['pms_subscription_plan_status'];
        ...
        if( isset( $_POST['pms_subscription_plan_duration_unit'] ) )
            update_post_meta( $post_id, 'pms_subscription_plan_duration_unit', $_POST['pms_subscription_plan_duration_unit'] );
        ...
        if( isset( $_POST['pms_subscription_plan_user_role'] ) ) {
            ...
            $new_role   = trim( $_POST['pms_subscription_plan_user_role'] );
