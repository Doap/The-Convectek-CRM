<?php
    ...
    function pms_pb_enqueue_scripts() {
        ...
        if( is_admin() )
            wp_enqueue_script( 'pms-pb-main-js', PMS_PLUGIN_DIR_URL . 'extend/assets/js/main.js', array( 'jquery' ) );
