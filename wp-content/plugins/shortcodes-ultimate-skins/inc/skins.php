...
?>
		<p><strong><?php _e( 'Shortcodes Ultimate: Additional Skins', 'sus' ); ?></strong></p>
		<div class="sunrise-inline-menu">
			<a href="<?php echo plugins_url( 'assets/css/heading.css', SUS_PLUGIN_FILE ); ?>">heading.css</a>
			<a href="<?php echo plugins_url( 'assets/css/quote.css', SUS_PLUGIN_FILE ); ?>">quote.css</a>
			<a href="<?php echo plugins_url( 'assets/css/spoiler.css', SUS_PLUGIN_FILE ); ?>">spoiler.css</a>
			<a href="<?php echo plugins_url( 'assets/css/tabs.css', SUS_PLUGIN_FILE ); ?>">tabs.css</a>
		</div>
<?php
	}
	...
	public static function examples( $examples ) {
		$examples['skins'] = array(
			'title' => __( 'Shortcodes Ultimate: Additional Skins', 'sus' ),
			'items' => array(
				array(
	...
	public static function meta_links( $links, $file ) {
		if ( $file === plugin_basename( SUS_PLUGIN_FILE ) ) $links[] = '<a href="http://gndev.info/cs/" target="_blank">' . __( 'Customer support', 'sus' ) . '</a>';
		return $links;
	}
}
